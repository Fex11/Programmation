 ...
 * @author fex
 */
public class DetailPoketra extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Poketra p=Poketra.getAllInfoById(c, id);
            c.close();
            request.setAttribute("poketra",p);
            request.getRequestDispatcher("detailPoketra.jsp").forward(request, response);
        } catch (Exception ex) {
